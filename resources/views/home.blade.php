...
<div class="flex inline-flex">
    @foreach ($kirgu as $product)
        <div class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
            <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                <img class="object-cover" src="https://avatars.mds.yandex.net/i?id=e7fe8cb1a0c31503119cfbb6655e6b89953ff10a-10105725-images-thumbs&n=13"/>
                <span class="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">5% OFF</span>
            </a>
